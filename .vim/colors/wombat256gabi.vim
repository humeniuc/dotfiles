...
let g:colors_name = "wombat256gabi"
...
call <SID>X("Visual",		"000000",	"c4c4c4",	"none")
call <SID>X("LineNr",		"857b6f",	"121212",	"none")

" modificare ca la intrarea in modul insert sa se coloreze coloana cu cifre
"echo <SID>rgb('cc3300')
"au insertEnter * hi LineNr guifg=#cc3300 ctermfg=160
"au InsertLeave * hi LineNr guifg=#857b6f ctermfg=101
